...
/* packages/resource-by-day-grid/src/View.svelte generated by Svelte v4.2.19 */
...
// (25:8) {#if loops[1].length > 1}
function create_if_block_2(ctx) {
	let div;
	let div_class_value;
	let current;
	let each_value_5 = ensure_array_like(/*loops*/ ctx[3][1]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*$theme, loops, $_intlDayHeaderAL, $_intlDayHeader, $datesAboveResources, resourceLabels*/ 252) {
				each_value_5 = ensure_array_like(/*loops*/ ctx[3][1]);
				let i;
...
function create_else_block_1(ctx) {
	...
	label = new Label({ props: { resource: /*item0*/ ctx[20] } });
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const label_changes = {};
			if (dirty[0] & /*loops*/ 8) label_changes.resource = /*item0*/ ctx[20];
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			div = element("div");
			time = element("time");
			attr(time, "datetime", time_datetime_value = toISOString(/*item0*/ ctx[20], 10));
			attr(time, "aria-label", time_aria_label_value = /*$_intlDayHeaderAL*/ ctx[6].format(/*item0*/ ctx[20]));
			attr(div, "class", div_class_value = "" + (/*$theme*/ ctx[5].day + " " + /*$theme*/ ctx[5].weekdays?.[/*item0*/ ctx[20].getUTCDay()]));
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, time);
			...
			if (!mounted) {
				dispose = action_destroyer(setContent_action = setContent.call(null, time, /*$_intlDayHeader*/ ctx[7].format(/*item0*/ ctx[20])));
				mounted = true;
			}
		},
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*loops*/ 8 && time_datetime_value !== (time_datetime_value = toISOString(/*item0*/ ctx[20], 10))) {
				attr(time, "datetime", time_datetime_value);
			}

			if (dirty[0] & /*$_intlDayHeaderAL, loops*/ 72 && time_aria_label_value !== (time_aria_label_value = /*$_intlDayHeaderAL*/ ctx[6].format(/*item0*/ ctx[20]))) {
				attr(time, "aria-label", time_aria_label_value);
			}

			if (setContent_action && is_function(setContent_action.update) && dirty[0] & /*$_intlDayHeader, loops*/ 136) setContent_action.update.call(null, /*$_intlDayHeader*/ ctx[7].format(/*item0*/ ctx[20]));

			if (dirty[0] & /*$theme, loops*/ 40 && div_class_value !== (div_class_value = "" + (/*$theme*/ ctx[5].day + " " + /*$theme*/ ctx[5].weekdays?.[/*item0*/ ctx[20].getUTCDay()]))) {
				attr(div, "class", div_class_value);
			}
		},
		i: noop,
...
function create_each_block_5(ctx) {
	...
	let mounted;
	let dispose;
	let each_value_6 = ensure_array_like(/*loops*/ ctx[3][0]);
	let each_blocks = [];
	...
	return {
		c() {
			...
			t1 = space();
			attr(time, "datetime", time_datetime_value = toISOString(/*item1*/ ctx[17], 10));
			attr(time, "aria-label", time_aria_label_value = "" + (/*resourceLabels*/ ctx[4][/*i*/ ctx[32]] + /*$_intlDayHeaderAL*/ ctx[6].format(/*item1*/ ctx[17])));
			attr(div0, "class", div0_class_value = "" + (/*$theme*/ ctx[5].day + " " + /*$theme*/ ctx[5].weekdays?.[/*item1*/ ctx[17].getUTCDay()]));
			attr(div0, "role", "columnheader");
			attr(div1, "class", div1_class_value = /*$theme*/ ctx[5].days);
			attr(div2, "class", div2_class_value = /*$theme*/ ctx[5].resource);
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = action_destroyer(setContent_action = setContent.call(null, time, /*$_intlDayHeader*/ ctx[7].format(/*item1*/ ctx[17])));
				mounted = true;
			}
		},
		p(new_ctx, dirty) {
			...
			if (!current || dirty[0] & /*loops*/ 8 && time_datetime_value !== (time_datetime_value = toISOString(/*item1*/ ctx[17], 10))) {
				attr(time, "datetime", time_datetime_value);
			}

			if (!current || dirty[0] & /*resourceLabels, $_intlDayHeaderAL, loops*/ 88 && time_aria_label_value !== (time_aria_label_value = "" + (/*resourceLabels*/ ctx[4][/*i*/ ctx[32]] + /*$_intlDayHeaderAL*/ ctx[6].format(/*item1*/ ctx[17])))) {
				attr(time, "aria-label", time_aria_label_value);
			}

			if (setContent_action && is_function(setContent_action.update) && dirty[0] & /*$_intlDayHeader, loops*/ 136) setContent_action.update.call(null, /*$_intlDayHeader*/ ctx[7].format(/*item1*/ ctx[17]));

			if (!current || dirty[0] & /*$theme, loops*/ 40 && div0_class_value !== (div0_class_value = "" + (/*$theme*/ ctx[5].day + " " + /*$theme*/ ctx[5].weekdays?.[/*item1*/ ctx[17].getUTCDay()]))) {
				attr(div0, "class", div0_class_value);
			}

			if (dirty[0] & /*$theme, loops, $_intlDayHeaderAL, $_intlDayHeader, $datesAboveResources, resourceLabels*/ 252) {
				each_value_6 = ensure_array_like(/*loops*/ ctx[3][0]);
				let i;
			...
			if (!current || dirty[0] & /*$theme*/ 32 && div1_class_value !== (div1_class_value = /*$theme*/ ctx[5].days)) {
				attr(div1, "class", div1_class_value);
			}

			if (!current || dirty[0] & /*$theme*/ 32 && div2_class_value !== (div2_class_value = /*$theme*/ ctx[5].resource)) {
...
function create_default_slot_2(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*loops*/ ctx[3][1].length > 1 && create_if_block_2(ctx);
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*$_viewResources, $theme, $_viewDates, $datesAboveResources*/ 39 | dirty[1] & /*$$scope*/ 8) {
...
function create_else_block(ctx) {
	let each_1_anchor;
	let current;
	let each_value_3 = ensure_array_like(/*$_viewDates*/ ctx[0]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*$theme, $_viewResources, $_viewDates*/ 35) {
				each_value_3 = ensure_array_like(/*$_viewDates*/ ctx[0]);
				let i;
...
// (67:16) {#if $datesAboveResources}
function create_if_block_1(ctx) {
	let each_1_anchor;
	let current;
	let each_value_2 = ensure_array_like(/*$_viewResources*/ ctx[1]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*$theme, $_viewDates, $_viewResources*/ 35) {
				each_value_2 = ensure_array_like(/*$_viewResources*/ ctx[1]);
				let i;
...
// (76:28) {#each $_viewResources as resource}
function create_each_block_4(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const week_changes = {};
			if (dirty[0] & /*$_viewDates*/ 1) week_changes.dates = [/*date*/ ctx[26]];
			if (dirty[0] & /*$_viewResources*/ 2) week_changes.resource = /*resource*/ ctx[23];
...
// (68:20) {#each $_viewResources as resource}
...
// (88:0) {#each loops[1] as item1}
function create_each_block(ctx) {
	let div;
	let t;
	let div_class_value;
	let current;
	let each_value_1 = ensure_array_like(/*loops*/ ctx[3][0]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*$datesAboveResources, loops*/ 12) {
				each_value_1 = ensure_array_like(/*loops*/ ctx[3][0]);
				let i;
...
function create_default_slot(ctx) {
	let each_1_anchor;
	let current;
	let each_value = ensure_array_like(/*loops*/ ctx[3][1]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*$theme, loops, $datesAboveResources*/ 44) {
				each_value = ensure_array_like(/*loops*/ ctx[3][1]);
				let i;
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*$theme, loops, $_intlDayHeaderAL, $_intlDayHeader, $datesAboveResources, resourceLabels*/ 252 | dirty[1] & /*$$scope*/ 8) {
				section_changes.$$scope = { dirty, ctx };
			}
			...
			if (dirty[0] & /*loops, $theme, $datesAboveResources*/ 44 | dirty[1] & /*$$scope*/ 8) {
